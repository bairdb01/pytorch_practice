...
import torch.optim as optim # Various methods to update weights
...
print(len(params)) # Learnable parameters
...
#     f.data.sub_(f.grad.data * learning_rate) # subtract in place
